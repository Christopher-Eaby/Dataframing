...
#intalizing data for the dataframe
data = {'Chips':  ['Simba', 'Lays',''],
        'Cooldrinks': ['Coke', 'Fanta', ''],
        'Chocolates': ['Cadbury', 'Tex', ''],
        'Pies': ['Pepper Steak', 'Chicken', ''],
        'Fruit': ['Pear', 'Apple', 'Orange'],
        'Cupcakes': ['Vanilla', 'Choclate', ''],
        'Veggies': ['Spinach', 'Cabbage', '']
        }

#creates the dataframe
df = pd.DataFrame (data, columns = ['Chips', 'Cooldrinks', 'Chocolates', 'Pies', 'Fruit', 'Cupcakes', 'Veggies'])   
